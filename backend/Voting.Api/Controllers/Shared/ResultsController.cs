...
using Voting.Api.Contracts.Responses.Shared;

namespace Voting.Api.Controllers.Shared;
...
public class ResultsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetResults(Guid electionId)
    {
        ...
        var offices = new List<OfficeResultResponse>();
        ...
        foreach (var office in Enum.GetValues<Office>())
        {
            ...
            var results = voteGroups
                .Select(g => new CandidateResultResponse(
                    g.CandidateId,
            ...
            offices.Add(new OfficeResultResponse(
                office.ToString(),
                results,
                winners,
                isTie
        ...
        return Ok(new ElectionResultsResponse(
            election.Id,
            election.Name,
            totalEligible,
            totalVoted,
