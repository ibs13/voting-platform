...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> RequestOtp([FromBody] AuthRequestOtpRequest dto)
    {
    ...
    [HttpPost("verify-otp")]
    public async Task<ActionResult> VerifyOtp([FromBody] AuthVerifyOtpRequest dto)
    {
        var email = dto.Email.Trim().ToLowerInvariant();
